(function ($) {
    ...
    (function(){
        var $blog = $('.blog_column4');
        var blogCount = $blog.children().length || 0;
        $blog.owlCarousel({
            loop: blogCount > 4,
        nav: true,
        autoplay: false,
    ...
    /*---brand container activation---*/
     (function(){
        ...
        var brandCount = $brand.children().length || 0;
        $brand.on('changed.owl.carousel initialized.owl.carousel', function (event) {
